...
public class UserRegisterLoginService {
    ...
    public String verifyUserOtp(OtpRequestDTO otpRequest)  {
        ...
        if (emailExists) {
            ...
            User user = new User(tempUser.getUserName(),
                    email, tempUser.getEncodedPassword(),tempUser.getMobile(),tempUser.getAddress(),false,false,false,true);
    ...
    public LoginResponseDTO validateUser(LoginRequestDTO loginRequestDTO){
        ...
        return new LoginResponseDTO(token,user, "Login successful and Token generated");
    }

    public String completeProfile(ProfileCompletionDTO profileDTO, String authHeader) {
