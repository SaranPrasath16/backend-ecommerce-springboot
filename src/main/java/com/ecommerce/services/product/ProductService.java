...
public class ProductService {
	...
	public List<Product> getRandomProducts() {
		List<Product> productList=productRepo.findRandomProducts();
        if(!productList.isEmpty()){
            return productList;
        }
        throw new ResourceNotFoundException("No Products found.");
	...
	public List<ProductGetResponseDTO> getProductByProductId(String productId) {
	    Query query = new Query(Criteria.where("productId").regex(productId));
