...
public class OrderService {
	...
	public Map<String, Object> checkout() {
	    ...
	    if (!user.isProfileCompleted()) {
	        throw new ResourceNotFoundException("Please complete your profile with mobile number and address before proceeding to checkout.");
	    }
	...
	public OrderAddResponseDTO placeOrder(String payloadBody, String razorpaySignature) {
	    ...
	    if (razorInvoiceId == null || razorInvoiceId.isEmpty()) {
	        throw new ResourceNotFoundException("Invoice Id is not found");
	    }
	    Payment payment = paymentRepo.findByInvoiceId(razorInvoiceId);
	    if (payment == null) {
	        throw new ResourceNotFoundException("No payment found with Invoice ID: " + razorInvoiceId);
	    }
