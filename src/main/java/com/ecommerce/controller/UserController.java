...
public class UserController {
    ...
    @AuthRequired
    public ResponseEntity<List<ProductGetResponseDTO>> getProductByProductId(@RequestParam("product_Id") String productId){
    	List<ProductGetResponseDTO> productGetResponseDTO = userImpl.getProductByProductId(productId);
        return ResponseEntity.ok(productGetResponseDTO);
    }
